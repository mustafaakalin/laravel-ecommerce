            ...
            Product::class => [
                'collection-schema' => [
                    'fields' => [
                        ...
                        ['name' => 'old_price', 'type' => 'float', 'facet' => true, 'optional' => true],
                        ['name' => 'is_active', 'type' => 'bool', 'facet' => true],
                        ['name' => 'is_featured', 'type' => 'bool', 'facet' => true, 'optional' => true],
                        ['name' => 'is_new', 'type' => 'bool', 'facet' => true, 'optional' => true],
                        ['name' => 'discount', 'type' => 'int32', 'facet' => true, 'optional' => true],
                        ...
                        ['name' => 'meta_keywords', 'type' => 'string', 'optional' => true],
                        ['name' => 'search_keywords', 'type' => 'string', 'optional' => true],
                        ['name' => 'is_digital', 'type' => 'bool', 'facet' => true, 'optional' => true],
                        ['name' => 'view_count', 'type' => 'int32', 'facet' => true],
                        ['name' => 'sku', 'type' => 'string'],
                        ['name' => 'tags', 'type' => 'string[]'],
                        ['name' => 'is_free_shipping', 'type' => 'bool', 'facet' => true],
                ...
                'search-parameters' => [
                    ...
                    'highlight_fields' => 'name,description,tags',
                    'filter_by' => '',
                    'sort_by' => '',
                ],
            ],
